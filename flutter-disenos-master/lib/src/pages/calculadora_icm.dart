...
class _HomeState extends State<Home> {
  String _info = "Introduce tus detalles";
  ...
  void _calcular() {
    setState(() {
      ...
      print(imc);
      if (imc < 18.6) {
        _info = 'Bajo peso (${imc.toStringAsPrecision(3)})';
      } else if (imc >= 18.6 && imc < 24.9) {
        _info = 'Peso Ideal (${imc.toStringAsPrecision(3)})';
      } else if (imc >= 24.9 && imc < 29.9) {
        _info = 'Un poco de sobrepeso (${imc.toStringAsPrecision(3)})';
